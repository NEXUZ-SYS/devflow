...
# (via detect-frontend) e, default-on, ativa o subsistema de design (/devflow:devflow-design init)
...
if ! grep -qiE "/devflow:devflow-design init|frontend-design init" "$SKILL"; then
