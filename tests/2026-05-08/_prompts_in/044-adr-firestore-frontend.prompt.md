...
- **Stack:** Firestore
- **Versao fixada:** SDK v12
- **Camada arquitetural alvo:** Camada 1 — Frontend
- **Papel nesta camada:** Base operacional canonica
- **Categoria:** arquitetura
- **Slug sugerido:** adr-firestore-frontend
...
- `description: Firestore SDK v12 como Base operacional canonica na camada Frontend`
- `stack: Firestore`
...
- **Filename:** `<NNN>-adr-firestore-frontend-v1.0.0.md` onde `<NNN>` e o proximo numero 3-digitos zero-padded.
