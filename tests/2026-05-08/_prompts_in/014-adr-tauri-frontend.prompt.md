...
- **Papel nesta camada:** Shell desktop nativo (WebView do SO)
- **Categoria:** arquitetura
- **Slug sugerido:** adr-tauri-frontend
...
- **Filename:** `<NNN>-adr-tauri-frontend-v1.0.0.md` onde `<NNN>` e o proximo numero 3-digitos zero-padded.
