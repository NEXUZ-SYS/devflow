...
- **Stack:** Next.js
- **Versao fixada:** 16.2.x
- **Camada arquitetural alvo:** Camada 1 — Frontend
- **Papel nesta camada:** Framework React full-stack
- **Categoria:** arquitetura
- **Slug sugerido:** adr-nextjs-frontend
...
- **Filename:** `<NNN>-adr-nextjs-frontend-v1.0.0.md` onde `<NNN>` e o proximo numero 3-digitos zero-padded.
