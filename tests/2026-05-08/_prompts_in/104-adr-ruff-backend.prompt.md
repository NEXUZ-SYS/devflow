...
- **Papel nesta camada:** Lint + format Python
- **Categoria:** principios-codigo
- **Slug sugerido:** adr-ruff-backend
...
- `description: ruff 0.9.x como Lint + format Python na camada Backend`
- `stack: ruff`
...
- **Filename:** `<NNN>-adr-ruff-backend-v1.0.0.md` onde `<NNN>` e o proximo numero 3-digitos zero-padded.
