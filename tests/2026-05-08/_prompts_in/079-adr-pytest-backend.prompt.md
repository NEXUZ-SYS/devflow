...
- **Papel nesta camada:** Test runner Python
- **Categoria:** qualidade-testes
- **Slug sugerido:** adr-pytest-backend
...
- **Filename:** `<NNN>-adr-pytest-backend-v1.0.0.md` onde `<NNN>` e o proximo numero 3-digitos zero-padded.
