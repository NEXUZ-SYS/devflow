...
- **Versao fixada:** nativo
- **Camada arquitetural alvo:** Camada 2 — BFF
- **Papel nesta camada:** CI/CD
- **Categoria:** infraestrutura
- **Slug sugerido:** adr-github-actions-bff
...
- `description: GitHub Actions nativo como CI/CD na camada BFF`
- `stack: GitHub Actions`
...
- **Filename:** `<NNN>-adr-github-actions-bff-v1.0.0.md` onde `<NNN>` e o proximo numero 3-digitos zero-padded.
