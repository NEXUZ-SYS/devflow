...
- **Papel nesta camada:** Lint + format TS/JS
- **Categoria:** principios-codigo
- **Slug sugerido:** adr-biome-frontend
...
- `description: Biome 2.x como Lint + format TS/JS na camada Frontend`
- `stack: Biome`
...
- **Filename:** `<NNN>-adr-biome-frontend-v1.0.0.md` onde `<NNN>` e o proximo numero 3-digitos zero-padded.
