...
- **Stack:** FastAPI
- **Versao fixada:** 0.135.x
- **Camada arquitetural alvo:** Camada 3 — Backend
- **Papel nesta camada:** Framework Python async
- **Categoria:** arquitetura
- **Slug sugerido:** adr-fastapi-backend
...
- **Filename:** `<NNN>-adr-fastapi-backend-v1.0.0.md` onde `<NNN>` e o proximo numero 3-digitos zero-padded.
