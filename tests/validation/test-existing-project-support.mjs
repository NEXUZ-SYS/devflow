...
describe("using-devflow: existing project documentation", () => {
  ...
  it("should list /devflow:devflow-sync workflow command", () => {
    assert.ok(
      usingDevflow.includes("devflow:devflow-sync workflow"),
      "must list /devflow:devflow-sync workflow in slash commands"
    );
  });
