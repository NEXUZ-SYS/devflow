...
- **Papel nesta camada:** Organizacao por layers
- **Categoria:** arquitetura
- **Slug sugerido:** adr-feature-sliced-design-frontend
...
- `description: Feature-Sliced Design 2.x como Organizacao por layers na camada Frontend`
- `stack: Feature-Sliced Design`
...
- **Filename:** `<NNN>-adr-feature-sliced-design-frontend-v1.0.0.md` onde `<NNN>` e o proximo numero 3-digitos zero-padded.
