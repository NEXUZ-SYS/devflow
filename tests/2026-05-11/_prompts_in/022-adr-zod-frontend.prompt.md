...
- **Papel nesta camada:** Schema validation runtime TS
- **Categoria:** qualidade-testes
- **Slug sugerido:** adr-zod-frontend
...
- **Filename:** `<NNN>-adr-zod-frontend-v1.0.0.md` onde `<NNN>` e o proximo numero 3-digitos zero-padded.
