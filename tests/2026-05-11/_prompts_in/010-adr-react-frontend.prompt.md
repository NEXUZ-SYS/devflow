...
- **Stack:** React
- **Versao fixada:** 19.2.x
- **Camada arquitetural alvo:** Camada 1 — Frontend
- **Papel nesta camada:** Biblioteca de UI
- **Categoria:** arquitetura
- **Slug sugerido:** adr-react-frontend
...
- **Filename:** `<NNN>-adr-react-frontend-v1.0.0.md` onde `<NNN>` e o proximo numero 3-digitos zero-padded.
