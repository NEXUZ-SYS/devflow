...
- **Papel nesta camada:** Traces de agentes e tools
- **Categoria:** infraestrutura
- **Slug sugerido:** adr-datadog-llm-observability-bff
...
- **Filename:** `<NNN>-adr-datadog-llm-observability-bff-v1.0.0.md` onde `<NNN>` e o proximo numero 3-digitos zero-padded.
