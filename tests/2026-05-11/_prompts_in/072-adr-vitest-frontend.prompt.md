...
- **Papel nesta camada:** Test runner unit + component
- **Categoria:** qualidade-testes
- **Slug sugerido:** adr-vitest-frontend
...
- **Filename:** `<NNN>-adr-vitest-frontend-v1.0.0.md` onde `<NNN>` e o proximo numero 3-digitos zero-padded.
