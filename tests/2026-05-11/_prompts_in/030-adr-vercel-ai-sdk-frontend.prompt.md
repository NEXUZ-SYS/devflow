...
- **Papel nesta camada:** SDK universal para LLMs
- **Categoria:** arquitetura
- **Slug sugerido:** adr-vercel-ai-sdk-frontend
...
- `description: Vercel AI SDK v6 como SDK universal para LLMs na camada Frontend`
- `stack: Vercel AI SDK`
...
- **Filename:** `<NNN>-adr-vercel-ai-sdk-frontend-v1.0.0.md` onde `<NNN>` e o proximo numero 3-digitos zero-padded.
