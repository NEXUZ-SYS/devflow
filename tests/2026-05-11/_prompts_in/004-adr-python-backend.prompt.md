...
- **Stack:** Python
- **Versao fixada:** 3.13.x
- **Camada arquitetural alvo:** Camada 3 — Backend
- **Papel nesta camada:** Linguagem dos servicos de dominio
- **Categoria:** arquitetura
- **Slug sugerido:** adr-python-backend
...
- `description: Python 3.13.x como Linguagem dos servicos de dominio na camada Backend`
- `stack: Python`
...
- **Filename:** `<NNN>-adr-python-backend-v1.0.0.md` onde `<NNN>` e o proximo numero 3-digitos zero-padded.
