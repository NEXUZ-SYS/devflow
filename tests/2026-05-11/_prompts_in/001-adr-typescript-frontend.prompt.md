...
- **Slug sugerido:** adr-typescript-frontend
...
- `description: TypeScript 5.9.x como Linguagem tipada para toda a stack JS na camada Frontend`
- `stack: TypeScript`
...
- **Filename:** `<NNN>-adr-typescript-frontend-v1.0.0.md` onde `<NNN>` e o proximo numero 3-digitos zero-padded.
