...
- **Papel nesta camada:** State management de cliente
- **Categoria:** arquitetura
- **Slug sugerido:** adr-zustand-frontend
...
- **Filename:** `<NNN>-adr-zustand-frontend-v1.0.0.md` onde `<NNN>` e o proximo numero 3-digitos zero-padded.
