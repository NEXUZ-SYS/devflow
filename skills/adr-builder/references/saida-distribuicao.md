...
DevFlow grava ADRs diretamente em `.context/adrs/NNN-<slug>-v<semver>.md`. Não há staging em diretório temporário, nem empacotamento `.zip` — o working tree git serve como staging, e cada ADR vira um commit (ver Steps 4-5 do SKILL.md).
...
- Pode escrever direto em `.context/adrs/`
