...
**Tip:** If Minimal mode, suggest running `/flow init` to scaffold `.context/` and unlock Lite mode.
...
- **devflow:project-init** (`/flow init`) — produces good content via codebase exploration
