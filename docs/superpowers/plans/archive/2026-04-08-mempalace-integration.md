...
| `commands/recall.md` | `/devflow:devflow-recall <query>` command definition |
...
| `commands/devflow.md` | Add `/devflow:devflow-recall` to help text |
...
```
/devflow:devflow-recall <query>            # Search within project wing
/devflow:devflow-recall --global <query>   # Search across all projects
```
...
```
/devflow:devflow-recall o que decidimos sobre auth
/devflow:devflow-recall architect diary última sessão
/devflow:devflow-recall --global caching strategy
```
```
...
git commit -m "feat(commands): add /devflow:devflow-recall command"
```
...
- [ ] **Step 2: Add /devflow:devflow-recall to Slash Commands table**
...
git commit -m "feat(using-devflow): add memory-recall skill and /devflow:devflow-recall command"
```
...
- [ ] **Step 1: Add /devflow:devflow-recall to the help text**
...
git commit -m "feat(commands): add /devflow:devflow-recall to devflow help text"
```
