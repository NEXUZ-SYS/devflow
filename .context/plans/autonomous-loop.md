...
> Add autonomy modes (supervised/assisted/autonomous) to DevFlow PREVC workflow. 10 tasks: stories.yaml schema, autonomous-loop skill, prevc-flow/execution/planning modifications, command docs, hook updates, Node.js safety net runner, integration verification.
