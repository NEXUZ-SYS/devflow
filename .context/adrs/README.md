...
| 005 | Spans gen_ai.* + devflow.* extension namespace, opt-in via observability.yaml | v1.0.0 | infraestrutura | universal | Organizational | Proposto | gated | — | — | — | 2026-05-06 | 8 | [005-observability-otel-genai-v1.0.0.md](005-observability-otel-genai-v1.0.0.md) |
